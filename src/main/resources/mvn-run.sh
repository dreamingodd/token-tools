...
java -classpath "target/token-tools.jar:target/lib/*" com.temp.AirDropByContract "/opt/token-tools/src/test/resources/air-drop-FT-voting-3.csv" "0xb17df9a3b09583a9bdcf757d6367171476d4d8a3" "0xd3a79de5B70D788bFf9Cc455Af80fC4dE1B8F940" "1"
